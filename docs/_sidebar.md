...
- 📖 **Blogs** <!-- Parent section -->
    ...
    - [Murder Mystery: A Differential Equation Application](diff_apps.md)
    - [Sieve of Eratosthenes: Time Complexity using Inclusion-Exclusion Principle](sieve.md)
